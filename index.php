    ...
    <body>
        ...
        <div class="conteudo">
            ...
            <div class="conteudo-instrucao">
                ...
                <p><input type="checkbox" checked=true readonly="true">1 - No arquivo 'DeefineCredenciais.php' definir as variaveis de acordo com as configurações do seu banco de dados local.</p>
                <p><input type="checkbox" checked=true readonly="true">2 - Criar um banco de dados chamado entrevista.</p>
